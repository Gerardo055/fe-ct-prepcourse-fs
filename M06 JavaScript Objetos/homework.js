...
function crearGato(nombre, edad) {
   ...
   persona.meow = function(){return("Meow!") };
   return persona;
...
function agregarPropiedad(objeto, propiedad) {
   ...
   // Retornar el objeto.
   // Tu código:
   objeto[propiedad] = null; return objeto;
}
...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   if (!objetoUsuario.email ) return false;
   else return true;
}
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // Tu código:
   //objetoUsuario={posts1:[objetos ={likes}], posts2 =[likes]}
